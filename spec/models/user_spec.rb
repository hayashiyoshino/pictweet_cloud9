...
describe User do
  describe '#create' do
    ...
    it "is invalid without a nickname" do
      ...
      # スペックファイルの中ではそのRailsプロジェクトで作成しているモデルクラスを利用するkぉとができる。
      user.valid?
      # valid?メソッドはバリデーションにより保存ができない状態にあるかを確かめることができるメソッド。
      expect(user.errors[:nickname]).to include("can't be blank")
      # errorメソッドはバリデーションにより保存ができない状態にある場合なぜできないのかを確認することができるメソッド。
    end
